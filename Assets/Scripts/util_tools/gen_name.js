...
public function nameGen(){	
			...
			var Random1 = parseInt(Random.Range(0,characters1.length));
			var Random2 = parseInt(Random.Range(0,characters2.length));
			var Random3 = parseInt(Random.Range(0,characters3.length));
			var Random4 = parseInt(Random.Range(0,characters4.length));	
			var Random5 = parseInt(Random.Range(0,characters5.length));
